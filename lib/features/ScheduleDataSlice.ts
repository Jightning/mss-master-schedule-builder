...
export const scheduleDataSlice = createSlice({
    ...
    reducers: {
        newRows: (state, action) => {
            console.log("NEW ROWS: " + action.payload)
...
export const selectRows = (state: { scheduleData: { rows: Row[] } }) => state.scheduleData.rows
export const selectColumns = (state: { scheduleData: { columns: Column[] }}) => state.scheduleData.columns
export const selectSelections = (state: { scheduleData: { selections: Selection[] }}) => state.scheduleData.selections
